...
"}*/"));
        ...
        widget_image_view->setAutoFillBackground(false);
        widget_image_view->setStyleSheet(QString::fromUtf8("QWidget { background-color: white; }"));
        ...
        label_image->setMinimumSize(QSize(0, 140));
...
"}"));
        ...
        groupBox_2->setMinimumSize(QSize(240, 120));
        groupBox_2->setMaximumSize(QSize(280, 120));
...
"}*/"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("MainWindow", "\346\225\260\346\215\256\345\244\204\347\220\206", nullptr));
